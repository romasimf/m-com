...
ActiveRecord::Schema[8.1].define(version: 2026_05_27_221004) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.check_constraint "user_one_id <> user_two_id", name: "conversations_users_not_equal"
  end
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.check_constraint "follower_id <> followed_id", name: "follows_users_not_equal"
  end
